# Sequential Study Notes Generator

Create a concise, chapter-following summary that captures every essential point in its original order. The reader will add personal insights as they read—your notes should provide the baseline they can build on.

## PROCESS

1. **Mirror the Chapter's Structure**: Introduce ideas and concepts in the order as they appeared in the text.
2. **Tone**: Neutral, concise, clear. No opinions, no fluff.
