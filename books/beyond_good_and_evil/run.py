...
config = RunConfig(
    book_id="beyond_good_and_evil",
    book_name="Beyond Good and Evil",
    author_name="Friedrich Nietzsche",
    input_file=Path(r"books/beyond_good_and_evil/input_transformed.md"),
    output_dir=Path(r"books/beyond_good_and_evil/output"),
    original_file=Path(r"books/beyond_good_and_evil/input_transformed.md"),
    phases=run_phases,
    max_workers=10,
)
...
def main() -> None:
    ...
    logger = setup_logging("beyond_good_and_evil")
    try:
