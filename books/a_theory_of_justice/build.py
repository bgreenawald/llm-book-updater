"""
Build script for A Theory of Justice (Timeless Library Edition).
...
class ATheoryOfJusticeBuilder(BaseBookBuilder):
    """
    Book-specific builder for A Theory of Justice.
    ...
    def get_source_files(self) -> Dict[str, Path]:
        """
        Get the source file paths for A Theory of Justice.
    ...
    def get_original_file(self) -> Optional[Path]:
        """
        Get the original source file for A Theory of Justice.
...
def build(version: str, name: str):
    """
    Build function for A Theory of Justice.
    ...
    config = BookConfig(
        name=name,
        version=version,
        title="A Theory of Justice (Timeless Library Edition)",
        author="John Rawls",
    )

    # Create and run the builder
    builder = ATheoryOfJusticeBuilder(config=config)
    builder.build()
