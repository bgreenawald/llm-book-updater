"""
Build script for The Varieties of Religious Experience (Timeless Library Edition).
...
class VarietiesOfReligiousExperienceBuilder(BaseBookBuilder):
    """
    Book-specific builder for The Varieties of Religious Experience.
    ...
    def get_source_files(self) -> Dict[str, Path]:
        """
        Get the source file paths for The Varieties of Religious Experience.
    ...
    def get_original_file(self) -> Optional[Path]:
        """
        Get the original source file for The Varieties of Religious Experience.
...
def build(version: str, name: str):
    """
    Build function for The Varieties of Religious Experience.
    ...
    config = BookConfig(
        name=name,
        version=version,
        title="The Varieties of Religious Experience (Timeless Library Edition)",
        author="William James",
    )

    # Create and run the builder
    builder = VarietiesOfReligiousExperienceBuilder(config=config)
    builder.build()
