"""
Build script for The Use Of Knowledge In Society (Timeless Library Edition).
...
class TheUseOfKnowledgeInSocietyBuilder(BaseBookBuilder):
    """
    Book-specific builder for The Use Of Knowledge In Society.
    ...
    def get_source_files(self) -> Dict[str, Path]:
        """
        Get the source file paths for The Use Of Knowledge In Society.
    ...
    def get_original_file(self) -> Optional[Path]:
        """
        Get the original source file for The Use Of Knowledge In Society.
...
def build(version: str, name: str):
    """
    Build function for The Use Of Knowledge In Society.
    ...
    config = BookConfig(
        name=name,
        version=version,
        title="The Use Of Knowledge In Society (Timeless Library Edition)",
        author="Friedrich Hayek",
    )

    # Create and run the builder
    builder = TheUseOfKnowledgeInSocietyBuilder(config=config)
    builder.build()
