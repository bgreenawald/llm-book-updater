...
config = StudyGuideConfig(
    ...
    input_file=Path("books/the_use_of_knowledge_in_society/output/03-input_transformed Final_two_stage_1.mdr"),
    output_dir=Path("books/the_use_of_knowledge_in_society/output/study_guide"),
    original_file=Path("books/the_use_of_knowledge_in_society/input_transformed.md"),
...
def main() -> None:
    ...
    logger = setup_logging("study_guide_the_use_of_knowledge_in_society")
    try:
