...
config = RunConfig(
    ...
    input_file=Path(r"books/the_use_of_knowledge_in_society/input_transformed.md"),
    output_dir=Path(r"books/the_use_of_knowledge_in_society/output"),
    original_file=Path(r"books/the_use_of_knowledge_in_society/input_transformed.md"),
    phases=run_phases,
    max_workers=10,
)
