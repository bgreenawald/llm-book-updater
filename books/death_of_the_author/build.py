"""
Build script for The Death of the Author (Timeless Library Edition).
...
class DeathOfTheAuthorBuilder(BaseBookBuilder):
    """
    Book-specific builder for The Death of the Author.
    ...
    def get_source_files(self) -> Dict[str, Path]:
        """
        Get the source file paths for The Death of the Author.
    ...
    def get_original_file(self) -> Optional[Path]:
        """
        Get the original source file for The Death of the Author.
...
def build(version: str, name: str):
    """
    Build function for The Death of the Author.
    ...
    config = BookConfig(
        name=name,
        version=version,
        title="The Death of the Author (Timeless Library Edition)",
        author="Roland Barthes",
    )

    # Create and run the builder
    builder = DeathOfTheAuthorBuilder(config=config)
    builder.build()
