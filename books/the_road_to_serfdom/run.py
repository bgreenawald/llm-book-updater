...
config = RunConfig(
    ...
    input_file=Path(r"books/the_road_to_serfdom/input_transformed.md"),
    output_dir=Path(r"books/the_road_to_serfdom/output"),
    original_file=Path(r"books/the_road_to_serfdom/input_transformed.md"),
    phases=run_phases,
    max_workers=10,
)
...
def main() -> None:
    ...
    logger = setup_logging("the_road_to_serfdom")
    try:
